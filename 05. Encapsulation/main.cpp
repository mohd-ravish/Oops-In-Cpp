...
all the characteristics (class variable) and behaviour (class methods) in one
block, encapsulating it together.
2. We introduce access modifiers (public, private, protected) etc to provide
data security to the class members.
*/
...
public:
    ...
    void setTyreCompany(string tyreCompany) { this->tyreCompany = tyreCompany; }
...
int main() {
    ...
    // cout << "Current Speed of My Sports Car is set to " <<
    // mySportsCar->currentSpeed << endl;
